        ...
        <div className="max-w-md w-full">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-600 mt-2">
              We've sent a password reset linl to your email address.
            </p>
          </div>
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-rate-600 mt-2">Enter your email address and we'll send you a link to reset your password.</p>
        </div>
