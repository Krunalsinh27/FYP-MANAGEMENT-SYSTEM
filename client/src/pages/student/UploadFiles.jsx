        ...
        <div className="card">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            <div className="border-2 border-dashed border-slate-300 rounded-lg p-6 text-center hover:border-blue-400 transition-colors">
              ...
              <h3 className="text-lg font-medium to-slate-800 mb-4">Report</h3>
            ...
            <div className="border-2 border-dashed border-slate-300 rounded-lg p-6 text-center hover:border-blue-400 transition-colors">
              ...
              <h3 className="text-lg font-medium to-slate-800 mb-4">Presentation</h3>
            ...
            <div className="border-2 border-dashed border-slate-300 rounded-lg p-6 text-center hover:border-blue-400 transition-colors">
              ...
              <h3 className="text-lg font-medium to-slate-800 mb-4">Code Files</h3>
