...
const ManageTeachers = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingTeacher) {
        await dispatch(updateTeacher({ id: editingTeacher._id, data: formData })).unwrap();
      }
      handleCloseModal();
    } catch (err) {
                        ...
                        <tr key={teacher._id} className="hover:bg-slate-50">
                          <td className="px-6 py-4">
                            <div>
                              ...
                              <div className="text-sm font-medium text-slate-500">{teacher.email}</div>
                            </div>
                          </td>
                          ...
                          <td className="px-6 py-4">
                            <div className="text-sm text-slate-900">{teacher.createdAt ? new Date(teacher.createdAt).toLocaleDateString() : "-"}</div>
                          </td>
