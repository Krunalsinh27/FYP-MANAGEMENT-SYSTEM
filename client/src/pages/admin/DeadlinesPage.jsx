    ...
    <div className="space-y-6">
      ...
      <div className="card">
        <div className="card-header flex flex-col md:flex-row justify-between items-start md:items-center">
          <div>
            <h1 className="card-title">Manage Deadline</h1>
            <p className="card-subtitle">Create and monitor project deadlines</p>
          </div>
          <button onClick={() => setShowModal(true)} className="btn-primary mt-4 md:mt-0" >Create/Update Deadline</button>
        </div>
      </div>
      ...
      <div className="card">
        <div className="flex flex-col md:flex-row gap-4">
          <div className="flex-1">
            ...
            <input type="text" placeholder="Search by project or student..." className="input-field w-full" value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} />
                    ...
                    <tr key={row._id} className="hover:bg-slate-50" >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        {row.supervisor !== "-" ? (
                          ...
                          <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs 
                          font-medium bg-gray-100 text-green-800">
                            Not Assigned
                          </span>
                        )}
                      </td>
            ...
            <div className="bg-white rounded-lg p-6 w-full max-w-3xl mx-4 max-h-screen overflow-y-auto">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input type="text" className="input" placeholder="Start typing to search projects..." value={query} onChange={(e) => {
