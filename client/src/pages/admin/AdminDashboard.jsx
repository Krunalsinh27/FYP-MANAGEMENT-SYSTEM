  ...
  return <>
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg p-6 text-white">
        ...
        <p className="text-blue-100">Manage the entire project management system and oversee all activities.</p>
      </div>
          ...
          <div className="p-4">
            {
              supervisorsBucket.length === 0 ? (
                <div className="h-64 flex items-center justify-center bg-slate-50 rounded text-slate-500">No data</div>
              ) : (
                <div className="h-72">
                  <ResponsiveContainer width={"100%"} height={"100%"}>
                    <BarChart data={supervisorsBucket} margin={{ top: 8, right: 8, bottom: 8, left: 8 }} barCategoryGap={"20%"}>
